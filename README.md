# Responsible_CR
Responsible CR is a JavaFX-based academic management system developed to simplify classroom communication and reduce the workload of Class Representatives (CRs). In many universities CRs are responsible for collecting and distributing academic information, managing communication between students and faculty members, and coordinating various classroom activities. This often creates communication bottlenecks and information gaps where important updates may be delayed or missed.

To address these challenges, Responsible CR provides a centralized platform where Students, CRs, and Faculty Members can interact through dedicated role-based functionalities. The system allows users to access notices, class routines, exam schedules, study materials, and academic updates from a single location, ensuring that information reaches the right people efficiently.
...
4.Study material and resource sharing
5.Classroom voting and polling system
